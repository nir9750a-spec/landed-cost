...
באמצעות Claude + כלי `web_search` (חיפוש אינטרנט חי), ובונה לכל מוצר **"תיק מקור"
(sourcing dossier)** שמטרתו לעקוף מתווכים ולהגיע ישירות ליצרן:
מקור (מדינה/אזור ייצור + נמל), זמן שילוח ים/אוויר, תקינה ואישורים נדרשים בשוק היעד,
מחיר קנייה ליחידה ישירות מהמפעל + MOQ, ופלייבוק לעקיפת מתווכים כולל מילות חיפוש
באנגלית ובסינית (ל-1688).
